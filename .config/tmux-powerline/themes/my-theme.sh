...
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'orange'}
# shellcheck disable=SC2034
TMUX_POWERLINE_SEG_AIR_COLOR=$(air_color)
# TMUX_POWERLINE_SEG_AIR_COLOR='black'
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		# "hostname 33 0"
		"mode_indicator default_fg_color default_bg_color"
		#"ifstat 30 255"
		#"ifstat_sys 30 255"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"cpu 240 136"
		# "load 237 167"
		"tmux_mem_cpu_load default_bg_color green"
		# "battery 137 127"
