...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/rogrp/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/rogrp/.mailcheckrc"
# }
...
# mode_indicator.sh {
	...
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_NORMAL_MODE_TEXT_COLOR="orange"
	# Prefix mode text & color overrides. Defaults to "prefix" & the segment foreground color set in the theme used.
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_PREFIX_MODE_TEXT="#[bg=orange]#[fg=black][ #S ]#[bg=default]"
	...
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_COPY_MODE_TEXT_COLOR="yellow"
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/rogrp/.now_playing.log"
...
# tmux_mem_cpu_load.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="--mem-mode 2 --color --interval 1)"
# }
