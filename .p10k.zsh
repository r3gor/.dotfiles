# Generated by Powerlevel10k configuration wizard on 2024-02-06 at 23:57 -05.
...
# 2 lines, solid, full frame, darkest-ornaments, sparse, many icons, concise,
...
() {
  ...
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=243
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=064
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=034
  ...
  #
  typeset -g POWERLEVEL9K_DIR_CLASSES=() # hide folder icon
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%64F'   # green foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=64
